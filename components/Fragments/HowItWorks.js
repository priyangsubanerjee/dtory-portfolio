    ...
    <>
      <div className="flex flex-col gap-24 items-center text-white justify-center px-[50px] md:px-[100px]  min-h-[680px] bg-[#101010] py-20">
        <main className="flex flex-col items-center   gap-4">
            <div className="text-4xl md:text-5xl lg:text-6xl  font-semibold text-white">How it works</div>
            <div className="max-w-[300px] md:max-w-[450px] font-normal text-sm lg:text-lg   text-light text-center mx-auto">We will add a subheader here which will pull users like a fucking magnet</div>
        </main>
        <main className="max-w-[1500px] w-[90vw] grid grid-cols-1 lg:grid-cols-3 items-center lg:items-start justify-items-center gap-12 lg:gap-8 xl:gap-12">
            <div className="flex flex-col max-w-[300px] xl:max-w-[280px] min-h-[200px] lg:max-w-[280px] items-center gap-3">
              <span className="block h-[70px]">
                ...
                <Image alt="unlimited_creativity" src={'/images/1.svg'} width={85} height={85} />
              </span>
                <span className="block text-lg xl:text-xl font-semibold ">Unlimited Creativity</span>
            ...
            <Image alt="fast" src={'/images/2.svg'} width={70} height={48} />
                ...
                <span className="block text-lg xl:text-xl font-semibold ">Fast...omg...so fast?!?</span>
            ...
            <Image alt="satisfaction" src={'/images/3.svg'} width={53} height={51} />
</span>
                <span className="block text-lg xl:text-xl font-semibold ">100% Satisfaction Rate</span>
